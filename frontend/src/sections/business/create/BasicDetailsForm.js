...
const BasicDetailsForm = ({ basicDetailsData, setBasicDetailsData, handleNext, setErrorIndex }) => {
  ...
  const alertText = userType === 'admin' ?
    "You are about to register a business. Please select the user who is authorized to act on behalf of this organization.":
    "You are about to register a business. Please ensure that you are authorized to act on behalf of this organization. If you are not authorized, please contact your organization's administrator. You will register using your own user account." ;
