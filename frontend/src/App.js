...
function App() {
  ...
  if (isLoading) {
    ...
    return (
      <div id="loading-screen" className="fixed z-50 mb-4 h-screen w-full rounded bg-white px-8 pb-8 pt-6 shadow-md">
        <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 transform flex-col gap-3">
          ...
          <span className="block text-center font-mono text-lg font-semibold text-blue-500"> Loading... </span>
        </div>
      </div>
