...
const RideShareMyTakenPostViewWidget = ({
  postId,
  postUserId,
  posterName,
  posterImage,
    ...
    <WidgetWrapper m="2rem 0">
      ...
      {accepted && accepted.length > 0 && (
        <>
          ...
          <FlexBetween gap="0.5rem">
            <FlexBetween gap="1rem">
              <UserImage image={posterImage} />
              <Typography color={main}>{posterImage}</Typography>
            </FlexBetween>
...
export default RideShareMyTakenPostViewWidget;
