...
const ConsultantListing = () => {
  ...
  const [individualConsultants, setIndividualConsultants] = useState("");
  const [teamConsultants, setTeamConsultants] = useState("");
  ...
  useEffect(() => {
    const fetchIndividualConsultants = async () => {
                    ...
                    >
                      <div class="h-32 w-36">
                        <img
                          ...
                          src={consultant.teamImage}
                          alt=""
                        />
                      </div>
                      <div class="p-5">
                        <span>
                          <Link to={`/consultant/view/${consultant.user_id}`}>
            ...
            <div className="w-full ">
              ...
              <div className="w-full px-20 grid grid-cols-1 md:grid-cols-4 gap-4 mt-4 h-[300px] overflow-auto py-5">
                {individualConsultants &&
                  individualConsultants.map((consultant, index) => (
                    <div
                      key={index}
                      class="w-56 h-72 rounded-lg border flex flex-col items-center border-gray-200 bg-white shadow pt-10 px-4"
                    >
