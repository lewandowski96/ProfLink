...
import {
  fetchTestimonials,
  toInitialState,
} from "../../../store/reducers/testimonial";
...
const CustomerTestimonials = () => {
  ...
  const { testimonials, error, success, isLoading } = useSelector(
  ...
  return (
    <>
      ...
      >
        <CreateEditCustomerTestimonial
          onClose={onClose}
          customerTestimonial={customerTestimonial}
          businessId={id}
        />
      </Dialog>
      {customerTestimonialId && (
        <AlertCustomerTestimonialDelete
          title={""}
          open={openAlert}
          handleClose={handleAlertClose}
          deleteId={customerTestimonialId}
          businessId={id}
        />
      )}
      <Snackbar
