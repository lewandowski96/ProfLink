...
const CandiShortList = () => {
    ...
    const filteredCandidates = sampleData.filter((company) => {
        const matchesScore = !selectedScore || company.includes(selectedScore.toString());
        const matchesQuery =
            !searchQuery ||
    ...
    return (
        <div className="company-listing">
            <h2 className='text-3xl relative font-semibold left-24 font-mono'>Candidates Shortlist</h2>
