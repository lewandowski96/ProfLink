...
export function addAdvertisement(businessId, newAdvertisement) {
    return async () => {
        ...
        try {
            const response = await axios.post(`http://localhost:4000/api/business/${businessId}/advertisements`, newAdvertisement);
...
export function fetchAdvertisement(businessId, advertisementId) {
    return async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:4000/api/business/${businessId}/advertisements/${advertisementId}`);
...
export function fetchAdvertisements(businessId) {
    return async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:4000/api/business/${businessId}/advertisements`);
...
export function updateAdvertisement(businessId, updatedAdvertisement) {
    return async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:4000/api/business/${businessId}/advertisements/${updatedAdvertisement._id}`, updatedAdvertisement);
...
export function deleteAdvertisement(businessId, advertisementId) {
    return async () => {
        ...
        try {
            await axios.delete(`http://localhost:4000/api/business/${businessId}/advertisements/${advertisementId}`);
