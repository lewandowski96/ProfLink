...
exports.deleteAdvertisement = async (req, res) => {
    ...
    try {
        ...
        // Find the index of the advertisement in the advertisementDetails array
        const index = business.advertisementDetails.findIndex(ad => ad._id.toString() === adId);

        if (index === -1) {
            throw Error("Advertisement not found");
        }

        // Remove the advertisement from the advertisementDetails array
        business.advertisementDetails.splice(index, 1);
...
exports.deleteTestimonial = async (req, res) => {
    ...
    try {
        ...
        // Find the index of the advertisement in the customerTestimonials array
        const index = business.customerTestimonials.findIndex(testimonial => testimonial._id.toString() === testimonialId);

        if (index === -1) {
            throw Error("Testimonial not found");
        }

        // Remove the advertisement from the customerTestimonials array
        business.customerTestimonials.splice(index, 1);
